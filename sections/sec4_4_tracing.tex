...
best~\cite{hase2023does}. Of the \Vtrn{} records, \Vtrany{} put their map to a test, and those tests return it unreliable or
method-dependent and the image contribution weak. Artefact tokens are a further hazard for the
