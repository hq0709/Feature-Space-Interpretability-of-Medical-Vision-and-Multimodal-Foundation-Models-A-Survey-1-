...
Table~\ref{tab:families} states what each family requires and how far this corpus has taken it. Decoding
...
single-author, \Ngreysingle{} studies in all, six of them both. Excluding the grey deposits lowers the corpus-breadth tier of F8a$''$ alone and changes
