...
without a concept vocabulary fixed in advance. What they do not yet supply is an identifier: names
assigned under weak supervision pass their uncertainty to every claim built on them, and no study
trains a second seed, matches features across cohorts, or decomposes the connector output.
