...
classes of safeguards, each stated with what it licenses and what it does not
(Table~\ref{tab:vcov}). No aggregate control score is formed, and a statement that lacks a class is
