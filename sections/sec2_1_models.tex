...
The reviewed models fall into three architectural templates (Fig.~\ref{fig:overview}, Table~\ref{tab:models}):
unimodal vision encoders, dual image--text encoders, and multimodal large language models.
