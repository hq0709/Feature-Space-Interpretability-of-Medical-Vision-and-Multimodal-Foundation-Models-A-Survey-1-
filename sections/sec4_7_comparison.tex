...
counts are in the supplement). Geometry is task-linked geometry only (\S\ref{sec:method}); the sub-types of decoding and intervention are discussed in \S\ref{sec:decoding} and \S\ref{sec:intervention}.}
\label{tab:families}
