...
\renewcommand{\thetable}{S7}\input{tables/tab_profile}
\renewcommand{\thetable}{S8}\input{tables/tab_profileb}
\renewcommand{\thetable}{S9}\input{tables/tab_profilec}
\renewcommand{\thetable}{S10}\input{tables/tab_workflow}
\FloatBarrier

\section*{The evidence statements in full}
...
rather than averaged --- and the limit that most restricts it. Counts are on all records, flagged or not; the
...
which is why no pooled effect is reported. The three ordered outcomes use the
...
removes (the screen as a sensitivity is in S6).
\renewcommand{\thetable}{S11}\input{tables/tab_rubric}
\renewcommand{\thetable}{S12}\input{tables/tab_defects}
\FloatBarrier
...
\renewcommand{\thetable}{S13}\input{tables/tab_saedesign}
\FloatBarrier
...
\renewcommand{\thetable}{S14}\input{tables/tab_families_sub}
