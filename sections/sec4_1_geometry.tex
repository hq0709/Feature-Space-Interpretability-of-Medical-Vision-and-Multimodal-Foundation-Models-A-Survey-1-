...
objective rather than scale: by mutual nearest-neighbour overlap on chest radiography, matched
self-supervised encoders align most (40.4\%), label-supervised ones less
(21.1\%) and image--text ones least (3.3\%), and no image encoder aligns with a
...
AUC 0.82--0.99~\cite{zhang2025hospital}, site above 0.95 even after stain
normalisation~\cite{kmen2026robust}, and scanner from slide embeddings above
0.99~\cite{murchan2024deep}; between 14\% and 55\% of a patch embedding's
nearest neighbours reflect the centre rather than the
biology~\cite{saueressig2025histology,gustafsson2024evaluating}. Further audits report the same
structure~\cite{jung2026foundation,shafique2026investigating,esbri2025benchmarking}.
...
prominent directions. What the family has not settled is whether the objectives that set out to shrink the modality gap
actually shrink it, since those are assessed on downstream accuracy rather than on the gap itself.
Across the family, \Vgeoany{} of the \Vgeon{} records compare their statistic with a second model or a
null.
