...
Intrinsic designs make a concept layer auditable and intervenable. Where the comparison is reported,
task accuracy is competitive with the same backbone without the concept layer, but accuracy cannot
show faithfulness, which needs valid concepts and controlled leakage. \Vintrany{} of the
